...
## Android Setup (Windows PowerShell)

If you don't have bash, run the PowerShell wizard as Administrator:

```powershell
Set-ExecutionPolicy -ExecutionPolicy Bypass -Scope Process
.\scripts\setup-android-wizard.ps1
```

Then restart your terminal and build:
